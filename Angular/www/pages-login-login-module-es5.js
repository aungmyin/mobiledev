(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginPage = /** @class */ (function () {
                function LoginPage(router, authService, storageService, toastService, menu, langServe) {
                    // this.menuActive();
                    this.router = router;
                ...
                LoginPage.prototype.menuActive = function () {
                ...
                LoginPage.prototype.languageDefault = function () {
                    this.postData.language = 'jp';
                    this.postData.pages = 'login';
                    // console.log("language selecct", this.postData);
                    this.langServe.languageData(this.postData).subscribe(function (res) {
                        console.log(res);
                    });
                };
                return LoginPage;
