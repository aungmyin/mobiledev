(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-changepassword-changepassword-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChangepasswordPage = /** @class */ (function () {
                function ChangepasswordPage(menu, router, toastService, authoService, langSwitch, langServe) {
                    this.menu = menu;
                    this.router = router;
                ...
                ChangepasswordPage.prototype.ngOnInit = function () {
                    var _this = this;
                    this.authoService.userData$.subscribe(function (res) {
                        console.log(res);
                        _this.dlyuser = res;
                    });
                    this.languageDefault();
                };
                ChangepasswordPage.prototype.languageDefault = function () {
                    var _this = this;
                    ...
                    this.langSwitch.langSwitchData$.subscribe(function (res) {
                        ...
                        _this.postData.pages = 'changepass';
                ...
                ChangepasswordPage.prototype.menuActive = function () {
                    this.activeMenu = "first";
                    this.menu.enable(false, "first");
                };
                ChangepasswordPage.prototype.validateInputs = function () {
                    var new_password = this.postData.new_password.trim();
                    var old_password = this.postData.old_password.trim();
                ...
                ChangepasswordPage.prototype.changePasswordAction = function () {
                    var _this = this;
                    if (this.validateInputs()) {
                        ...
                        this.authoService.updatepassword(this.postData).subscribe(function (res) {
                            console.log(res);
                            if (res.status == 1) {
                                //console.log("changed");
                                _this.postData.new_password = '';
                                _this.postData.old_password = '';
                                _this.router.navigate(['home/messages']);
                            }
                            else if (res.error) {
                                ...
                                _this.toastService.presentToast(res[0]['password']);
                            }
                        }, function (error) {
                ...
                ChangepasswordPage.prototype.gotoPagesAction = function (urls) {
