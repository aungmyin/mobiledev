...
let TransportationexpensesPageRoutingModule = class TransportationexpensesPageRoutingModule {
};
...
let TransportationexpensesPageModule = class TransportationexpensesPageModule {
};
...
let TransportationexpensesPage = class TransportationexpensesPage {
    constructor(authService, router, route, transportServ, toastService, renderer) {
    ...
    getTransportData() {
        ...
        if (this.postData.member_id) {
            ...
            this.transportServ.transportExpenseData(this.postData).subscribe((res) => {
...
TransportationexpensesPage.ctorParameters = () => [
