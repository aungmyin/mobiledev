...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                {
                    path: '',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | index-index-module */ "index-index-module").then(__webpack_require__.bind(null, /*! ./index/index.module */ "./src/app/index/index.module.ts")).then(function (m) { return m.IndexPageModule; }); }
                },
                {
                    path: '',
                ...
                },
                {
                    ...
                    loadChildren: function () { return Promise.all(/*! import() | pages-forgot-password-forgot-password-module */ [__webpack_require__.e("default~pages-changepassword-changepassword-module~pages-client-client-module~pages-customerwkreport~8db89b57"), __webpack_require__.e("pages-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/forgot-password/forgot-password.module */ "./src/app/pages/forgot-password/forgot-password.module.ts")).then(function (m) { return m.ForgotPasswordPageModule; }); }
                },
                {
                    path: 'edit-profile',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(platform, splashScreen, statusBar, authServices, router, menu) {
                    var _this = this;
                    ...
                    this.menu = menu;
                    this.initializeApp();
                    this.authServices.userData$.subscribe(function (res) {
                        _this.authUser = res;
                    });
                }
                ...
                AppComponent.prototype.logoutAction = function () {
                    this.authServices.logout();
                    //window.location.href="/login";
                };
                AppComponent.prototype.goSettingAction = function () {
                    this.router.navigate(['home/settings']);
                    this.closeMenu();
                };
                AppComponent.prototype.goHelpAction = function () {
                    this.router.navigate(['home/help']);
                    this.closeMenu();
                };
                AppComponent.prototype.gotProfileAction = function () {
                    this.router.navigate(['home/messages']);
                    this.closeMenu();
                };
                AppComponent.prototype.gotoWorkReportAction = function () {
                    this.router.navigate(['home/workreport']);
                    this.closeMenu();
                };
                AppComponent.prototype.gotoPagesAction = function (urls) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(httpService, storageService, router, tmplCompiler) {
                ...
                AuthService.prototype.logout = function () {
                    ...
                    localStorage.clear();
                    this.storageService.removeItems(_config_auth_constants__WEBPACK_IMPORTED_MODULE_6__["AuthConstants"].AUTH).then(function (res) {
                        _this.userData$.next('');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HttpService = /** @class */ (function () {
                ...
                HttpService.prototype.post = function (serviceName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
                    var options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrlfeed + serviceName;
                    return this.http.post(url, JSON.stringify(data), options);
                };
                HttpService.prototype.get = function (serviceName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*"
                    });
                    var options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?email=" + data.username + "&password=" + data.password + "&company=" + data.company;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getForgotPassword = function (serviceName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*"
                    });
                    var options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?email=" + data.username + "&company=" + data.company;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getWorkReportDetail = function (serviceName, data) {
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?year=" + data.year + "&month=" + data.month + "&member_id=" + data.member_id;
                    return this.http.get(url, options);
                };
                HttpService.prototype.uploadPDFWorkReportDetail = function (serviceName, formData, data) {
                ...
                HttpService.prototype.removePDFCustomerWorkreport = function (serviceName, workreport, data) {
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?workreport_client_id=" + workreport + "&member_id=" + data.member_id;
                    return this.http.get(url, options);
                };
                HttpService.prototype.removeClientInfo = function (serviceName, data) {
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?member_id=" + data.member_id + "&workreport_client_id=" + data.workreport_client_id;
                    return this.http.get(url, options);
                };
                HttpService.prototype.showClientListByUser = function (serviceName, data) {
                    console.log(data, "http data");
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'access-token': data.token
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?member_id=" + data.member_id + "&year=" + data.year + "&month=" + data.month;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getUserGuide = function (serviceName, data) {
                    // console.log(data, " Help")
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*"
                    });
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?lang=" + data.language + "&filename=" + data.filename;
                    return this.http.get(url, options);
                };
                HttpService.prototype.addClientInfo = function (serviceName, clientInfo, data) {
                    console.log(data, "http data");
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'access-token': data.token
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?member_id=" + data.member_id + "&client_id=" + clientInfo.client_id + "&project_id=" + clientInfo.project_id + "&individual_contract_id=" + clientInfo.individual_contract_id + "&year=" + data.year + "&month=" + data.month;
                    return this.http.get(url, options);
                };
                //download workreport excel
                HttpService.prototype.workReportDownloadExcel = function (serviceName, data) {
                    console.log(data, "http data");
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                    ...
                    var options = { headers: headers, withCredintials: false };
                    var url = "https://wrkessence.phoenix.xyz" + serviceName + "?member_id=" + data.member_id + "&lang=" + data.language + "&idname=" + data.idname + "&year=" + data.year + "&month=" + data.month + "&auth_token=" + data.token;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getWorkReportDownloadExcel = function (serviceName, data) {
                    //console.log(data.year + data.month + data.member_id + "http data");
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'Content-Type': 'application/json',
                ...
                HttpService.prototype.updateWorkReportDetail = function (serviceName, data, postData) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'Content-Type': 'application/json',
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?account=" + postData.account + "&workreport_id=" + postData.workreport_id;
                    return this.http.post(url, data, options);
                };
                HttpService.prototype.applyWorkReportDetail = function (serviceName, data, postData) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'Content-Type': 'application/json',
                        'access-token': postData.token
                ...
                HttpService.prototype.getUserData = function (serviceName, postData) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'Content-Type': 'application/json',
                        'access-token': postData.token
                    ...
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?member_id=" + postData.email;
                    return this.http.get(url, options);
                };
                HttpService.prototype.sendEmailtoAdmin = function (serviceName, postData) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*",
                        'Content-Type': 'application/json',
                        'access-token': postData.token
                    ...
                    console.log(postData, "http profile");
                    var options = { headers: headers, withCredintials: true };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?member_id=" + postData.member_id + "&month=" + postData.month + "&lang=" + postData.language;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getLanguageData = function (serviceName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Access-Control-Allow-Origin': "*"
                    });
                    console.log(data);
                    var options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?lang=" + data.language + "&filename=" + data.pages;
                    return this.http.get(url, options);
                };
                HttpService.prototype.getupdatepsw = function (serviceName, data) {
                    ...
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?company=" + data.company + "&email=" + data.email + "&account=" + data.account + "&oldpass=" + data.old_password + "&newpass=" + data.new_password + "&member_id=" + data.member_id;
                    return this.http.get(url, options);
                };
                HttpService.prototype.forgotpassword = function (serviceName, data) {
                    var options = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                            'Access-Control-Allow-Origin': "*"
                        }),
                ...
                HttpService.prototype.recoverpass = function (serviceName, data) {
                    var options = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                            'Access-Control-Allow-Origin': "*",
                            'Content-Type': 'application/json',
                    ...
                    // const options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + data.rediRectUrl + "&reset=" + data.reset;
                    console.log(url, "recoverpass");
                    return this.http.get(url, options);
                };
                HttpService.prototype.changepass = function (serviceName, data) {
                    var options = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                            'Access-Control-Allow-Origin': "*",
                            'Content-Type': 'application/json',
                    ...
                    // const options = { headers: headers, withCredintials: false };
                    var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + serviceName + "?code=" + data.token + "&newpass=" + data.newPsw + "&confirm_pass=" + data.confirmPsw;
                    console.log(url, "changepass");
                    return this.http.get(url, options);
                };
                HttpService.prototype.checkTokenSession = function (serviceName, data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StorageService = /** @class */ (function () {
                ...
                StorageService.prototype.removeItems = function (storageKey) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Storage.remove({ key: storageKey })];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
