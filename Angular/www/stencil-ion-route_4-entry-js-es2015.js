...
const RouterLink = class {
    constructor(hostRef) {
        ...
        this.onClick = (ev) => {
            Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_3__["o"])(this.href, ev, this.routerDirection);
        };
    }
    render() {
