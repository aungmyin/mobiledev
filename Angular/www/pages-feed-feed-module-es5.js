(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-feed-feed-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FeedPage = /** @class */ (function () {
                function FeedPage(auth, menu, router, route, customerServices, langServe, langSwitch) {
                    var _this = this;
                    this.auth = auth;
                    this.menu = menu;
                    this.router = router;
                    ...
                    this.auth.userData$.subscribe(function (res) {
                        ...
                        console.log(res.status, _this.postData.token, "home 2");
                        //check token session
                        _this.checkTokenSession();
                        //check token is expire or not
                        if (res.status == 0 || _this.tokenExpire == 1) {
                            _this.logoutAction();
                        }
                    });
                }
                ...
                //logout action
                FeedPage.prototype.logoutAction = function () {
                    this.auth.logout();
                };
                FeedPage.prototype.languageDefault = function () {
                    var _this = this;
                    ...
                    this.langSwitch.langSwitchData$.subscribe(function (res) {
                        ...
                        if (!_this.postData.language) {
                            ...
                            console.log(_this.postData, 'default');
                        }
                        _this.postData.pages = 'home_mobile';
                ...
                FeedPage.prototype.checkTokenSession = function () {
                    var _this = this;
                    console.log(this.postData.token, "Token Session check is what Feed");
                    this.auth.checkTokenSession(this.postData).subscribe(function (res) {
                        console.log(res, "check Token Result is what Feed");
                        _this.tokenExpire = res.status;
                    });
                };
                FeedPage.prototype.greetingMessage = function () {
                    if (this.curtime <= 11) {
                ...
                FeedPage.prototype.gotoPagesAction = function (urls, tabsopen) {
                ...
                FeedPage.prototype.goMoreInfo = function (urls) {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    //console.log(this.postData.month + " login");
                    //search by date again
                    this.customerServices.getcustomerData(this.postData).subscribe(function (res) {
                        _this.newData = res;
                        //console.log(this.newData.customer_work_report);
                        _this.customerServices.updateCustomerData(res);
