...
let NeedHelpPageRoutingModule = class NeedHelpPageRoutingModule {
};
...
let NeedHelpPageModule = class NeedHelpPageModule {
};
...
let NeedHelpPage = class NeedHelpPage {
    constructor(sanitizer, http, router, langSwitch) {
