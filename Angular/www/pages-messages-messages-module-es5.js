(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-messages-messages-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MessagesPage = /** @class */ (function () {
                function MessagesPage(httpService, router, authService, menu, langServe) {
                ...
                MessagesPage.prototype.onRenderItems = function (event) {
                    console.log("Move item from " + event.detail.from + " to " + event.detail.to);
                    var draggedItem = this.listItems.splice(event.detail.from, 1)[0];
                    this.listItems.splice(event.detail.to, 0, draggedItem);
                    event.detail.complete();
                };
                MessagesPage.prototype.getList = function () {
                    console.table(this.listItems);
                };
                MessagesPage.prototype.getCurrentUserProfile = function () {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    console.log(this.postData);
                    this.authService.getUserDatail(this.authUser.email).subscribe(function (res) {
                        //console.log(res.show_detail);
                        _this.UserProfile = res.show_detail;
                        _this.memberNo = _this.UserProfile.member_no;
                        _this.memberNoFormat(_this.UserProfile.member_no);
                ...
                MessagesPage.prototype.memberNoFormat = function (mbno) {
                ...
                MessagesPage.prototype.authority = function (authId) {
                    if (authId == 2) {
                ...
                MessagesPage.prototype.employmentType = function (empId) {
                    if (empId == 0) {
                ...
                MessagesPage.prototype.employmentStatus = function (empStatus) {
                    if (empStatus == 1) {
                ...
                MessagesPage.prototype.changePasswordAction = function () {
                    this.router.navigate(['changepassword']);
                };
                MessagesPage.prototype.gotoPagesAction = function (urls) {
