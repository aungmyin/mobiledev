...
let ClientPage = class ClientPage {
    constructor(auth, toastService, route, router, clientService, langServe, langSwitch, authServe, http) {
        this.auth = auth;
    ...
    sendEmailtoAdmin() {
        this.authServe.sendEmailtoAdmin(this.postData).subscribe((res) => {
    ...
    showCustmers() {
        ...
        this.authServe.showClientListByUser(this.postData).subscribe((res) => {
    ...
    addCustomer(i) {
        ...
        this.authServe.addClientInfo(clients, this.postData).subscribe((res) => {
    ...
    delClientInfo(clid) {
        ...
        this.authServe.removeClientInfo(this.postData).subscribe((res) => {
