(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-workreport-workreport-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WorkreportPageRoutingModule = /** @class */ (function () {
                function WorkreportPageRoutingModule() {
                }
                return WorkreportPageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WorkreportPage = /** @class */ (function () {
                function WorkreportPage(auth, toastService, customerInfo, memberInfo, route, router, transportServ) {
                    this.auth = auth;
                ...
                WorkreportPage.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                WorkreportPage.prototype.doRefresh = function (event) {
                    var _this = this;
                ...
                WorkreportPage.prototype.getWorkReportData = function () {
                    var _this = this;
                    ...
                    if (this.postData.member_id) {
                        this.memberInfo.memberData(this.postData).subscribe(function (res) {
                            //console.log(res); //refresh data
                            _this.data = res;
                            _this.memberInfo.changeMemberData(res);
                        }, function (error) {
                ...
                WorkreportPage.prototype.expandedItem = function (item) {
                    item.expanded = !item.expanded;
                };
                WorkreportPage.prototype.goMoreInfo = function (urls) {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    ...
                    this.customerInfo.getcustomerData(this.postData).subscribe(function (res) {
                        ...
                        var navigationExtras = {
                            state: {
                                special: _this.newData.customer_work_report,
                ...
                WorkreportPage.prototype.goMoreInfoClient = function (urls) {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    //search by date again
                    this.customerInfo.getcustomerData(this.postData).subscribe(function (res) {
                        ...
                        console.log(_this.newData.project_info);
                        _this.customerInfo.updateCustomerData(res);
                        var navigationExtras = {
                            state: {
                                special: _this.newData.project_info,
                                clientrpflg: _this.clientRpFlg,
                                workingPattern: _this.workingPattern,
                ...
                WorkreportPage.prototype.goMoreInfoWorkReport = function (urls) {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    //console.log(this.postData.month + " login");
                    //search by date again
                    this.customerInfo.getcustomerData(this.postData).subscribe(function (res) {
                        ...
                        var navigationExtras = {
                            state: {
                                special: _this.wkreport_detail,
                                wkReport: _this.wkReport,
                                workPattern: _this.workPattern,
                                wkreport_detail_date: _this.wkreport_detail_date,
                                workingHour: _this.workingHour,
                                year: _this.postData.year,
                                month: _this.postData.month
                            }
                ...
                WorkreportPage.prototype.goMoreInfoTranExp = function (urls) {
                    var _this = this;
                    this.postData.member_id = this.authUser.email;
                    //console.log(this.postData.month + " login");
                    //search by date again
                    this.customerInfo.getcustomerData(this.postData).subscribe(function (res) {
                        _this.newData = res;
                        console.log(_this.newData.customer_work_report);
                        _this.customerInfo.updateCustomerData(res);
                        var navigationExtras = {
                            state: {
                                special: _this.newData.transport_expense,
                                year: _this.postData.year,
                                month: _this.postData.month
                            }
                        };
                ...
                WorkreportPage.prototype.gotoPagesAction = function (urls) {
                    this.router.navigate([urls]);
                };
                WorkreportPage.prototype.unread = function () {
                };
                return WorkreportPage;
            }());
            WorkreportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-workreport-workreport-module-es5.js.map
//# sourceMappingURL=pages-workreport-workreport-module-es5.js.map