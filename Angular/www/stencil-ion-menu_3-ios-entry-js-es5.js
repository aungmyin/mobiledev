...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stencil-ion-menu_3-ios-entry-js"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _index_e44ebcc6_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-e44ebcc6.js */ "./node_modules/@ionic/core/dist/esm/index-e44ebcc6.js");
            /* harmony import */ var _hardware_back_button_784b7e3c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./hardware-back-button-784b7e3c.js */ "./node_modules/@ionic/core/dist/esm/hardware-back-button-784b7e3c.js");
            /* harmony import */ var _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-9af8638a.js */ "./node_modules/@ionic/core/dist/esm/index-9af8638a.js");
            /* harmony import */ var _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-c2dc54d9.js */ "./node_modules/@ionic/core/dist/esm/theme-c2dc54d9.js");
            ...
            var Menu = /** @class */ (function () {
                function class_1(hostRef) {
                    ...
                    this.lastOnEnd = 0;
                    this.blocker = _index_e44ebcc6_js__WEBPACK_IMPORTED_MODULE_5__["GESTURE_CONTROLLER"].createBlocker({ disableScroll: true });
                    ...
                    this.ionWillOpen = Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionWillOpen", 7);
                    this.ionWillClose = Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionWillClose", 7);
                    this.ionDidOpen = Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionDidOpen", 7);
                    this.ionDidClose = Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionDidClose", 7);
                    this.ionMenuChange = Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionMenuChange", 7);
                }
                ...
                class_1.prototype.sideChanged = function () {
                    this.isEndSide = Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.side);
                };
                            ...
                            switch (_b.label) {
                                case 0:
                                    if (this.type === undefined) {
                                        this.type = _ionic_global_a175fa73_js__WEBPACK_IMPORTED_MODULE_1__["c"].get('menuType', 'overlay');
                                    }
                                    el = this.el;
                                    ...
                                    _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._register(this);
                                    _a = this;
                ...
                class_1.prototype.disconnectedCallback = function () {
                    ...
                    _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._unregister(this);
                    if (this.animation) {
                ...
                class_1.prototype.setOpen = function (shouldOpen, animated) {
                    if (animated === void 0) { animated = true; }
                    return _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._setOpen(this, shouldOpen, animated);
                };
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _a = this;
                                    return [4 /*yield*/, _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._createAnimation(this.type, this)];
                                case 1:
                                    // Create new animation
                                    _a.animation = _b.sent();
                                    if (!_ionic_global_a175fa73_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('animated', true)) {
                ...
                class_1.prototype.canStart = function (detail) {
                    ...
                    else if (_index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._getOpenSync()) {
                        return false;
                    }
                ...
                class_1.prototype.onStart = function () {
                    if (!this.isAnimating || !this.animation) {
                        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["b"])(false, 'isAnimating has to be true');
                        return;
                    }
                ...
                class_1.prototype.onEnd = function (detail) {
                     ...
                     */
                    newStepValue += Object(_cubic_bezier_685f606a_js__WEBPACK_IMPORTED_MODULE_4__["g"])([0, 0], [0.4, 0], [0.6, 1], [1, 1], Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, adjustedStepValue, 0.9999))[0] || 0;
                ...
                class_1.prototype.beforeAnimation = function (shouldOpen) {
                    Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["b"])(!this.isAnimating, '_before() should not be called while animating');
                ...
                class_1.prototype.afterAnimation = function (isOpen) {
                    Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this.isAnimating, '_before() should be called while animating');
                ...
                class_1.prototype.updateState = function () {
                    ...
                    if (!this.disabled) {
                        _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"]._setActiveMenu(this);
                    }
                    Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["b"])(!this.isAnimating, 'can not be animating');
                };
                class_1.prototype.forceClosing = function () {
                    Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this._isOpen, 'menu cannot be closed');
                    this.isAnimating = true;
                ...
                class_1.prototype.render = function () {
                    ...
                    return (Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "navigation", class: (_a = {},
                            _a[mode] = true,
                            ...
                            _a) }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "menu-inner", ref: function (el) { return _this.menuInnerEl = el; } }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-backdrop", { ref: function (el) { return _this.backdropEl = el; }, class: "menu-backdrop", tappable: false, stopPropagation: false })));
                };
            ...
            var updateVisibility = function (menu) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"].get(menu)];
                        case 1:
                            menuEl = _b.sent();
                            _a = menuEl;
            ...
            var MenuButton = /** @class */ (function () {
                function class_2(hostRef) {
                    ...
                    this.onClick = function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"].toggle(this.menu)];
                        });
                    }); };
                }
                ...
                class_2.prototype.render = function () {
                    ...
                    var mode = Object(_ionic_global_a175fa73_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
                    var menuIcon = _ionic_global_a175fa73_js__WEBPACK_IMPORTED_MODULE_1__["c"].get('menuIcon', mode === 'ios' ? 'menu-outline' : 'menu-sharp');
                    var hidden = this.autoHide && !this.visible;
                    var attrs = {
                        type: this.type
                    };
                    return (Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_8__["c"])(color)), { 'button': true, 'menu-button-hidden': hidden, 'menu-button-disabled': disabled, 'in-toolbar': Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_8__["h"])('ion-toolbar', this.el), 'in-toolbar-color': Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_8__["h"])('ion-toolbar[color]', this.el), 'ion-activatable': true, 'ion-focusable': true }) }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", Object.assign({}, attrs, { disabled: disabled, class: "button-native" }), Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "button-inner" }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { icon: menuIcon, mode: mode, lazy: false }))), mode === 'md' && Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", { type: "unbounded" }))));
                };
            ...
            var MenuToggle = /** @class */ (function () {
                function class_3(hostRef) {
                    ...
                    this.onClick = function () {
                        return _index_9af8638a_js__WEBPACK_IMPORTED_MODULE_7__["m"].toggle(_this.menu);
                    };
                }
                ...
                class_3.prototype.render = function () {
                    ...
                    var mode = Object(_ionic_global_a175fa73_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
                    var hidden = this.autoHide && !this.visible;
                    return (Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: (_a = {},
                            _a[mode] = true,
                            _a['menu-toggle-hidden'] = hidden,
                            _a) }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)));
                };
                return class_3;
            }());
...
//# sourceMappingURL=stencil-ion-menu_3-ios-entry-js-es2015.js.map
//# sourceMappingURL=stencil-ion-menu_3-ios-entry-js-es5.js.map
//# sourceMappingURL=stencil-ion-menu_3-ios-entry-js-es5.js.map