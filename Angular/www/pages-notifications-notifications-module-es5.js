(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-notifications-notifications-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotificationsPage = /** @class */ (function () {
                function NotificationsPage(auth, feedService, toastService) {
                    this.auth = auth;
                ...
                NotificationsPage.prototype.getFeedData = function () {
                    var _this = this;
                    ...
                    if (this.postData.user_id && this.postData.token) {
                        this.feedService.feedData(this.postData).subscribe(function (res) {
                            //console.log(res.feedData);
                            _this.feedService.changeFeedData(res.feedData);
                        }, function (error) {
