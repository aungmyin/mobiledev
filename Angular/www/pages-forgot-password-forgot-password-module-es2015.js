...
let ForgotPasswordPage = class ForgotPasswordPage {
    constructor(menu, authoService, toastService) {
        this.menu = menu;
    ...
    forgotPasswordAction() {
        if (this.validateInputs()) {
            ...
            this.authoService.forgotpassword(this.postData).subscribe((res) => {
                console.log(res);
                if (res.status == 1) {
    ...
    recoverpassAction() {
        ...
        this.authoService.recoverpass(this.postData).subscribe((res) => {
    ...
    changepassAction() {
        ...
        this.authoService.changepass(this.postData).subscribe((res) => {
