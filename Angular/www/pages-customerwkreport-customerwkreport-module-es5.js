(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-customerwkreport-customerwkreport-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerwkreportPageRoutingModule = /** @class */ (function () {
                function CustomerwkreportPageRoutingModule() {
                }
                return CustomerwkreportPageRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerwkreportPageModule = /** @class */ (function () {
                function CustomerwkreportPageModule() {
                }
                return CustomerwkreportPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomerwkreportPage = /** @class */ (function () {
                function CustomerwkreportPage(route, router, auth, toastService, customerServe) {
                    var _this = this;
                    this.route = route;
                    this.router = router;
                    this.auth = auth;
                    ...
                    this.route.queryParams.subscribe(function (params) {
                        if (_this.router.getCurrentNavigation().extras.state) {
                            _this.data = _this.router.getCurrentNavigation().extras.state.special;
                ...
                CustomerwkreportPage.prototype.ngOnInit = function () {
                    this.report_flgs = [
                        {
                            id: 0,
                            value: 'No'
                ...
                return CustomerwkreportPage;
            }());
            CustomerwkreportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-customerwkreport-customerwkreport-module-es5.js.map
//# sourceMappingURL=pages-customerwkreport-customerwkreport-module-es5.js.map